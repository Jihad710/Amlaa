      ...
      {openModalRs && (
        <form className="" onSubmit={handleSubmit(onSubmit)}>
          <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center ">
            <div className="bg-white w-full md:w-10/12 max-h-screen ">
              <div className="bg-blue-500 text-white flex justify-between">
                <h1 className="text-2xl font-bold p-4">Amla team</h1>
                <button
                  type="button"
                  onClick={handleClose}
              ...
              <div className="mx-auto border flex flex-col md:flex-row py-6  max-h-[calc(100vh-140px)]">
                <div className="w-full md:w-7/12 max-h-[calc(100vh-250px)]  px-3">
                ...
                <div className="w-full md:w-5/12 overflow-y-auto custom-scrollbar px-3">
                  <h1 className="text-xl font-medium mb-5 mt-5 text-center">
                    Order Summary
                  </h1>
                  <div className="border rounded p-1">
                      ...
                      >
                        <div className="flex">
                          <div className="relative overflow-hidden rounded w-[63px] h-[63px]">
                            <img
                              src={product.image || pleceholderImage}
                              alt={product.name}
                        ...
                        <p
                          className={`text-lg font-semibold ${
                            product.notAvailable && "line-through"
                          }`}
                        >
                          ৳
                          {product.discount
                    ...
                    <div className="flex justify-between">
                      ...
                      <p className="text-lg font-semibold">
                        ৳
                        {cartItems.reduce((total: number, product) => {
