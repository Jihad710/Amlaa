        ...
        <div className='md:w-11/12 w-full p-3 sm:mx-10 md:mx-auto mt-10 text-[#3c3633] md:mb-36'>
            <div className=' capitalize'>
                <div className='grid md:grid-cols-2 sm:gap-10 w-full'>
                    <div className='md:flex flex-row-reverse md:gap-5 border '>
                        <div className=''>
                            {mainImage && (
                                <img
                                    src={mainImage}
                        ...
                        <div className=''>
                            <div className='overflow-y-auto md:h-[500px] flex md:block justify-center gap-1 sm:gap-5 mt-5 sm:w-full w-[300px] overflow-x-auto mx-auto hide-scrollbar '>
